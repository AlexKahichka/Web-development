...
class DisconnectionError(SQLAlchemyError):
    ...
    the pool gives up and raises :class:`~sqlalchemy_project.exc.InvalidRequestError`
...
class NoInspectionAvailable(InvalidRequestError):
    """A subject passed to :func:`sqlalchemy_project.inspection.inspect` produced
...
class NoResultFound(InvalidRequestError):
    ...
    .. versionchanged:: 1.4  This exception is now part of the
       ``sqlalchemy_project.exc`` module in Core, moved from the ORM.  The symbol
       remains importable from ``sqlalchemy_project.orm.exc``.
...
class DontWrapMixin:
    ...
    E.g.::
        ...
        from sqlalchemy_project.exc import DontWrapMixin
...
class StatementError(SQLAlchemyError):
    ...
    @_preloaded.preload_module("sqlalchemy_project.sql.util")
    def _sql_message(self) -> str:
