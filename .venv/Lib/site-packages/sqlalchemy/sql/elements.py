...
def literal(
    ...
    subclass,
    such as a :class:`~sqlalchemy_project.schema.Column` object.  Use this function
    ...
    :param type\_: an optional :class:`~sqlalchemy_project.types.TypeEngine` which will
...
def literal_column(
    ...
    :param type\_: an optional :class:`~sqlalchemy_project.types.TypeEngine`
      object which will
...
class CompilerElement(Visitable):
    ...
    @util.preload_module("sqlalchemy_project.engine.default")
    @util.preload_module("sqlalchemy_project.engine.url")
    def compile(
        self,
        ...
        **kw: Any,
        ...
        :param compile_kwargs: optional dictionary of additional parameters
            ...
            for the case of passing the ``literal_binds`` flag through::
                ...
                from sqlalchemy_project.sql import table, column, select
...
class TextClause(
    ...
    @util.preload_module("sqlalchemy_project.sql.selectable")
    def columns(
        ...
        of a "selectable"::
            ...
            from sqlalchemy_project.sql import column, text
...
class FunctionFilter(ColumnElement[_T]):
    ...
    def over(
        ...
        is shorthand for::
            ...
            from sqlalchemy_project import over, funcfilter
...
class quoted_name(util.MemoizedSlots, str):
    ...
    an unconditionally quoted name::
        ...
        from sqlalchemy_project import inspect
        from sqlalchemy_project.sql import quoted_name
    ...
    .. versionchanged:: 1.2 The :class:`.quoted_name` construct is now
       importable from ``sqlalchemy_project.sql``, in addition to the previous
       location of ``sqlalchemy_project.sql.elements``.
