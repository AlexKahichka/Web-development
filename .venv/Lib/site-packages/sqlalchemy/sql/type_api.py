...
class TypeEngine(Visitable, Generic[_T]):
    ...
    class Comparator(
        ...
        @util.preload_module("sqlalchemy_project.sql.default_comparator")
        def operate(
    ...
    def with_variant(
        ...
        *dialect_names: str,
        ...
        e.g.::
            ...
            from sqlalchemy_project.types import String
            from sqlalchemy_project.dialects import mysql
    ...
    def _generic_type_affinity(
        ...
        for t in self.__class__.__mro__:
            if (
                t.__module__
                in (
                    "sqlalchemy_project.sql.sqltypes",
                    "sqlalchemy_project.sql.type_api",
                )
    ...
    def as_generic(self, allow_nulltype: bool = False) -> TypeEngine[_T]:
		...
		>>> from sqlalchemy_project import NVARCHAR
...
class UserDefinedType(
    ...
    more appropriate::
      ...
      import sqlalchemy_project.types as types
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    .. warning::
       ...
       be used in order to deal with operators like index operations::
            ...
            from sqlalchemy_project import JSON
