...
All entities are subclasses of :class:`~sqlalchemy_project.schema.SchemaItem`, and as
defined in this module they are intended to be agnostic of any vendor-specific
constructs.

A collection of entities are grouped into a unit called
:class:`~sqlalchemy_project.schema.MetaData`. MetaData serves as a logical grouping of
schema elements, and can also be associated with an actual database connection
such that operations involving the contained elements can contact the database
as needed.

Two of the elements here also build upon their "syntactic" counterparts, which
are defined in :class:`~sqlalchemy_project.sql.expression.`, specifically
:class:`~sqlalchemy_project.schema.Table` and :class:`~sqlalchemy_project.schema.Column`.
...
class Table(
    ...
    def append_column(
        ...
        :param replace_existing: When ``True``, allows replacing existing
            ...
            version of sqlalchemy_project will instead rise a warning.
    ...
    def __init__(
        ...
        **dialect_kwargs: Any,
        ...
        :param name: The name of this column as represented in the database.
          ...
          usage within the :mod:`~sqlalchemy_project.ext.declarative` extension.

        :param type\_: The column's type, indicated using an instance which
          subclasses :class:`~sqlalchemy_project.types.TypeEngine`.  If no arguments
        ...
        :param onupdate: A scalar, Python callable, or
            :class:`~sqlalchemy_project.sql.expression.ClauseElement` representing a
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            or :func:`~sqlalchemy_project.sql.expression.text` construct representing
            ...
            A :func:`~sqlalchemy_project.sql.expression.text` expression will be
            ...
            valid SQLAlchemy expressions or constructs::
                ...
                from sqlalchemy_project import Table, Column, MetaData, ARRAY, Text
                from sqlalchemy_project.dialects.postgresql import array
...
class ColumnElementColumnDefault(ColumnDefault):
    ...
    @util.memoized_property
    @util.preload_module("sqlalchemy_project.sql.sqltypes")
...
class Sequence(HasSchemaAttr, IdentityOptions, DefaultGenerator):
    ...
    @util.preload_module("sqlalchemy_project.sql.functions")
...
class MetaData(HasSchemaAttr):
    ...
    @util.preload_module("sqlalchemy_project.engine.reflection")
    def reflect(
        self,
...
class Computed(FetchedValue, SchemaItem):
    ...
    argument list of a :class:`_schema.Column` object::
        ...
        from sqlalchemy_project import Computed
...
class Identity(IdentityOptions, FetchedValue, SchemaItem):
    ...
    argument list of a :class:`_schema.Column` object::
        ...
        from sqlalchemy_project import Identity
