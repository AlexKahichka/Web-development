...
class Operators:
    ...
    :meth:`~sqlalchemy_project.sql.operators.Operators.operate` and
    :meth:`~sqlalchemy_project.sql.operators.Operators.reverse_operate`, as well as
    :meth:`~sqlalchemy_project.sql.operators.Operators.__and__`,
    :meth:`~sqlalchemy_project.sql.operators.Operators.__or__`,
    :meth:`~sqlalchemy_project.sql.operators.Operators.__invert__`.
    ...
    def __invert__(self) -> Operators:
        ...
        is equivalent to::
            ...
            from sqlalchemy_project import not_
            not_(a)
...
class custom_op(OperatorType, Generic[_T]):
    ...
    to represent the "factorial" operation::
        ...
        from sqlalchemy_project.sql import UnaryExpression
...
class ColumnOperators(Operators):
    ...
    :mod:`sqlalchemy_project.expression.operators`.   For example
    the ``__eq__`` function::
