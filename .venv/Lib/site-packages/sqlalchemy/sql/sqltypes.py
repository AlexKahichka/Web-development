    ...
    def __init__(
		...
		:param collation: Optional, a column-level collation for
		  ...
		  .. sourcecode:: pycon+sql
			...
			>>> from sqlalchemy_project import cast, select, String
        ...
        :param precision: the numeric precision for use in DDL ``CREATE
           ...
           .. note:: For the Oracle backend, the
              ...
              :meth:`_types.TypeEngine.with_variant` as follows::
                    ...
                    from sqlalchemy_project import Column
                    from sqlalchemy_project import Float
                    from sqlalchemy_project.dialects import oracle
...
class Enum(String, SchemaType, Emulated, TypeEngine[Union[str, enum.Enum]]):
    ...
    a plain-string enumerated type::
        ...
        import enum
        from sqlalchemy_project import Enum
    ...
    def _resolve_for_python_type(
        ...
        # as ``sqlalchemy_project.Enum(enum.Enum)`` which indicates we need to
    ...
    @util.preload_module("sqlalchemy_project.sql.schema")
    def _set_table(self, column, table):
...
class Interval(Emulated, _AbstractInterval, TypeDecorator[dt.timedelta]):
    ...
    :attr:`~sqlalchemy_project.sql.expression.func`).
...
class JSON(Indexable, TypeEngine[Any]):
    ...
    .. note::  :class:`_types.JSON`
       ...
       * PostgreSQL - see :class:`sqlalchemy_project.dialects.postgresql.JSON` and
         :class:`sqlalchemy_project.dialects.postgresql.JSONB` for backend-specific
         notes

       * MySQL - see
         :class:`sqlalchemy_project.dialects.mysql.JSON` for backend-specific notes

       * SQLite as of version 3.9 - see
         :class:`sqlalchemy_project.dialects.sqlite.JSON` for backend-specific notes

       * Microsoft SQL Server 2016 and later - see
         :class:`sqlalchemy_project.dialects.mssql.JSON` for backend-specific notes
    ...
    * Data casters for specific JSON element types, subsequent to an index
    ...
    :class:`sqlalchemy_project.dialects.postgresql.JSON` and
    :class:`sqlalchemy_project.dialects.postgresql.JSONB` which both offer additional
    ...
    * :meth:`.JSON.Comparator.as_integer` - return the element as an integer
    ...
    .. note::
        ...
        this looked like::
           ...
           from sqlalchemy_project import cast, type_coerce
           from sqlalchemy_project import String, JSON
           cast(
    ...
    **Detecting Changes in JSON columns when using the ORM**
    ...
    :mod:`sqlalchemy_project.ext.mutable` extension must be used, most typically
    ...
    **Support for JSON null vs. SQL NULL**
    ...
    should be SQL NULL as opposed to JSON ``"null"``::
        ...
        from sqlalchemy_project import null
    ...
    **Customizing the JSON Serializer**
    ...
    .. seealso::
        ...
        :class:`sqlalchemy_project.dialects.postgresql.JSON`

        :class:`sqlalchemy_project.dialects.postgresql.JSONB`

        :class:`sqlalchemy_project.dialects.mysql.JSON`

        :class:`sqlalchemy_project.dialects.sqlite.JSON`
    ...
    which always resolves to SQL NULL.  E.g.::
        ...
        from sqlalchemy_project import null
        from sqlalchemy_project.dialects.postgresql import JSON
...
class ARRAY(
    ...
    .. note::  This type serves as the basis for all ARRAY operations.
       ...
       :class:`sqlalchemy_project.dialects.postgresql.ARRAY` type directly when using
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    .. container:: topic
        ...
        **Detecting Changes in ARRAY columns when using the ORM**
        ...
        these, the :mod:`sqlalchemy_project.ext.mutable` extension must be used, using
        the :class:`.MutableList` class::

            from sqlalchemy_project import ARRAY
            from sqlalchemy_project.ext.mutable import MutableList
    ...
    .. seealso::
        ...
        :class:`sqlalchemy_project.dialects.postgresql.ARRAY`
    ...
    class Comparator(
        ...
        @util.preload_module("sqlalchemy_project.sql.elements")
        def any(self, other, operator=None):
            ...
            is as follows::
                ...
                from sqlalchemy_project.sql import operators
            ...
            :param operator: an operator object from the
             :mod:`sqlalchemy_project.sql.operators`
...
class Uuid(Emulated, TypeEngine[_UUID_RETURN]):
    ...
    **Python uuid objects**, from the Python
    ...
    module::
        ...
        from sqlalchemy_project import Uuid
        from sqlalchemy_project import Table, Column, MetaData, String
