...
class SQLCompiler(Compiled):
    ...
    @util.preload_module("sqlalchemy_project.engine.cursor")
    ...
    @util.memoized_property
    @util.preload_module("sqlalchemy_project.engine.result")
...
class IdentifierPreparer:
    ...
    @util.preload_module("sqlalchemy_project.sql.naming")
