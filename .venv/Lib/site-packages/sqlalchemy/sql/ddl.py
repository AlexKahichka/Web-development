...
class DDL(ExecutableDDLElement):
    ...
    Examples::
      ...
      from sqlalchemy_project import event, DDL
...
class CreateColumn(BaseDDLElement):
    ...
    compiler extension documented in :ref:`sqlalchemy_project.ext.compiler_toplevel`
    ...
    is found::
        ...
        from sqlalchemy_project import schema
    ...
    as follows::
        ...
        from sqlalchemy_project import Table, Metadata, Column, Integer, String
        from sqlalchemy_project import schema
