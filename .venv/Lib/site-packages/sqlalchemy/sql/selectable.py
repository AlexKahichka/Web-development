...
class Selectable(ReturnsRows):
    ...
    @util.deprecated(
        ...
        "functionality is available via the sqlalchemy_project.sql.visitors module.",
    )
    @util.preload_module("sqlalchemy_project.sql.util")
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def join(
        ...
        E.g.::
            ...
            from sqlalchemy_project import join
    ...
    def outerjoin(
        ...
        E.g.::
            ...
            from sqlalchemy_project import outerjoin
...
class NamedFromClause(FromClause):
    ...
    def table_valued(self) -> TableValuedColumn[Any]:
		...
		.. sourcecode:: pycon+sql
			...
			>>> from sqlalchemy_project import select, column, func, table
...
class SelectLabelStyle(Enum):
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> from sqlalchemy_project import table, column, select, true, LABEL_STYLE_NONE
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> from sqlalchemy_project import table, column, select, true, LABEL_STYLE_TABLENAME_PLUS_COL
        >>> table1 = table("table1", column("columna"), column("columnb"))
        >>> table2 = table("table2", column("columna"), column("columnc"))
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> from sqlalchemy_project import table, column, select, true, LABEL_STYLE_DISAMBIGUATE_ONLY
        >>> table1 = table("table1", column("columna"), column("columnb"))
        >>> table2 = table("table2", column("columna"), column("columnc"))
...
class Join(roles.DMLTableRole, FromClause):
    ...
    def _join_condition(
        ...
        *,
        ...
        See sqlalchemy_project.sql.util.join_condition() for full docs.
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    def add_cte(self, *ctes: CTE, nest_here: bool = False) -> Self:
        ...
        :class:`_postgresql.Insert` construct to generate an "upsert"::
            ...
            from sqlalchemy_project.dialects.postgresql import insert
    ...
    def cte(
        ...
        Example 1, non recursive::
            ...
            from sqlalchemy_project import (Table, Column, String, Integer,
        ...
        Example 3, an upsert using UPDATE and INSERT with CTEs::
            ...
            from sqlalchemy_project import (MetaData, Table, Column, Integer,
...
class TableClause(roles.DMLTableRole, Immutable, NamedFromClause):
    ...
    @util.preload_module("sqlalchemy_project.sql.dml")
