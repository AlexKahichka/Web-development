...
class DDLEvents(event.Events[SchemaEventTarget]):
    ...
    **Create / Drop Events**
    ...
    after ``CREATE TABLE`` is emitted::
        ...
        from sqlalchemy_project import Table, Column, Metadata, Integer
    ...
    **Use with Generic DDL**
    ...
    as listener callables::
        ...
        from sqlalchemy_project import DDL
        event.listen(
            some_table,
            "after_create",
    ...
    def column_reflect(
        ...
        by :meth:`.reflection.Inspector.get_columns`:
            ...
            * ``type`` - the type of this column, which should be an instance
              of :class:`~sqlalchemy_project.types.TypeEngine`, is applied to the
