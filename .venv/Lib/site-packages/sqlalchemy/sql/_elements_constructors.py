...
def and_(  # type: ignore[empty-body]
    ...
    *clauses: _ColumnExpressionArgument[bool],
    ...
    E.g.::
        ...
        from sqlalchemy_project import and_
    ...
    specified::
        ...
        from sqlalchemy_project import true
...
def asc(
    ...
    e.g.::
        ...
        from sqlalchemy_project import asc
...
def between(
    ...
    E.g.::
        ...
        from sqlalchemy_project import between
...
def outparam(
    ...
    :class:`~sqlalchemy_project.engine.CursorResult` object via its ``out_parameters``
...
def bindparam(
    ...
    time::
        ...
        from sqlalchemy_project import bindparam
...
def case(
    *whens: Union[
    ...
    constructs, that is, a list of conditions and results as tuples::
        ...
        from sqlalchemy_project import case
    ...
    as in::
        ...
        from sqlalchemy_project import case, literal_column
...
def cast(
    ...
    E.g.::
        ...
        from sqlalchemy_project import cast, Numeric
...
def try_cast(
    ...
    .. tip:: As :func:`_sql.try_cast` originates from the SQL Server dialect,
       it's importable both from ``sqlalchemy_project.`` as well as from
       ``sqlalchemy_project.dialects.mssql``.
    ...
    E.g.::
        ...
        from sqlalchemy_project import select, try_cast, Numeric
...
def column(
    ...
    constructs::
        ...
        from sqlalchemy_project.sql import column
    ...
    a working table construct with minimal boilerplate::
        ...
        from sqlalchemy_project import table, column, select
...
def desc(
    ...
    e.g.::
        ...
        from sqlalchemy_project import desc
...
def distinct(expr: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    an aggregate function, as in::
        ...
        from sqlalchemy_project import distinct, func
...
def extract(field: str, expr: _ColumnExpressionArgument[Any]) -> Extract:
    ...
    E.g.::
        ...
        from sqlalchemy_project import extract
        from sqlalchemy_project import table, column
...
def false() -> False_:
	...
	.. sourcecode:: pycon+sql
		...
		>>> from sqlalchemy_project import false
...
def funcfilter(
    ...
    E.g.::
        ...
        from sqlalchemy_project import funcfilter
...
def nulls_first(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    should be handled when they are encountered during ordering::
        ...
        from sqlalchemy_project import desc, nulls_first
...
def nulls_last(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    should be handled when they are encountered during ordering::
        ...
        from sqlalchemy_project import desc, nulls_last
...
def or_(  # type: ignore[empty-body]
    ...
    *clauses: _ColumnExpressionArgument[bool],
    ...
    E.g.::
        ...
        from sqlalchemy_project import or_
...
def text(text: str) -> TextClause:
    ...
    E.g.::
        ...
        from sqlalchemy_project import text
...
def tuple_(
    *clauses: _ColumnExpressionArgument[Any],
    ...
    :meth:`.ColumnOperators.in_` ::
        ...
        from sqlalchemy_project import tuple_
    ...
    .. warning::
        ...
        :class:`~sqlalchemy_project.exc.DBAPIError` when such an expression is
        invoked.
...
def type_coerce(
    ...
    E.g.::
        ...
        from sqlalchemy_project import type_coerce
...
def within_group(
    ...
    the :meth:`.FunctionElement.within_group` method, e.g.::
        ...
        from sqlalchemy_project import within_group
        stmt = select(
            department.c.id,
