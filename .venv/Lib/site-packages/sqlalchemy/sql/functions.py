...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    def scalar_table_valued(
		...
		.. sourcecode:: pycon+sql
			...
			>>> from sqlalchemy_project import func, select
    ...
    def columns(self) -> ColumnCollection[str, KeyedColumnElement[Any]]:  # type: ignore[override]  # noqa: E501
		...
		.. sourcecode:: pycon+sql
			...
			>>> from sqlalchemy_project import column, select, func
    ...
    def over(
        ...
        *,
        ...
        is shorthand for::
            ...
            from sqlalchemy_project import over
    ...
    def alias(
		...
		.. sourcecode:: pycon+sql
			...
			>>> from sqlalchemy_project import func, select, column
...
class _FunctionGenerator:
    ...
    :class:`~sqlalchemy_project.types.Unicode` as the type:
...
class GenericFunction(Function[_T]):
    ...
    be available immediately::
        ...
        from sqlalchemy_project.sql.functions import GenericFunction
    ...
    on or off for the name, use the :class:`.sqlalchemy_project.sql.quoted_name`
    construct::
