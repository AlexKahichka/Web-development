...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from sqlalchemy_project import (  # noqa: F401,E501
...
class Visitable:
    ...
    def _generate_compiler_dispatch(cls) -> None:
        ...
        if "_compiler_dispatch" in cls.__dict__:
            ...
            # sqlalchemy_project.ext.compiles overrides it.
...
class InternalTraversal(Enum):
    ...
    * :meth:`.HasCacheKey._gen_cache_key`
    ...
    The operator is a function from the :mod:`sqlalchemy_project.sql.operators`
    module.
...
class HasTraverseInternals:
    ...
    @util.preload_module("sqlalchemy_project.sql.traversals")
    def get_children(
...
def traverse(
    ...
    iterator.
     ...
     e.g.::
        ...
        from sqlalchemy_project.sql import visitors
