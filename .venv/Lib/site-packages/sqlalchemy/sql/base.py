...
@util.preload_module("sqlalchemy_project.dialects")
...
class ColumnCollection(Generic[_COLKEY, _COL_co]):
	...
	as ``tablename_columnname``::
		...
		>>> from sqlalchemy_project import select, column, table
		>>> from sqlalchemy_project import LABEL_STYLE_TABLENAME_PLUS_COL
		>>> t = table("t", column("c"))
