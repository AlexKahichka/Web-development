...
The :mod:`~sqlalchemy_project.ext.hybrid` extension provides a special form of
...
may receive the class directly, depending on context::
    ...
    from sqlalchemy_project.ext.hybrid import hybrid_method
    from sqlalchemy_project.ext.hybrid import hybrid_property
    from sqlalchemy_project.orm import DeclarativeBase
    from sqlalchemy_project.orm import Mapped
    from sqlalchemy_project.orm import mapped_column
...
expressions should be defined. The :mod:`~sqlalchemy_project.ext.hybrid` decorator
...
the absolute value function::
    ...
    from sqlalchemy_project import ColumnElement
...
``Interval.start``, this could be substituted directly::
    ...
    from sqlalchemy_project import update
...
mapping which relates a ``User`` to a ``SavingsAccount``::
    ...
    from sqlalchemy_project import ForeignKey
    from sqlalchemy_project import Numeric
    from sqlalchemy_project import String
    from sqlalchemy_project import SQLColumnExpression
    from sqlalchemy_project.ext.hybrid import hybrid_property
    from sqlalchemy_project.orm import DeclarativeBase
    from sqlalchemy_project.orm import Mapped
    from sqlalchemy_project.orm import mapped_column
    from sqlalchemy_project.orm import relationship
...
named ``word_insensitive``::
    ...
    from sqlalchemy_project import ColumnElement
    from sqlalchemy_project import func
    from sqlalchemy_project.ext.hybrid import Comparator
    from sqlalchemy_project.ext.hybrid import hybrid_property
    from sqlalchemy_project.orm import DeclarativeBase
    from sqlalchemy_project.orm import Mapped
    from sqlalchemy_project.orm import mapped_column
...
.. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy_project import aliased
