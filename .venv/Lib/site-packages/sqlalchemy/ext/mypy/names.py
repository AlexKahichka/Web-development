...
NAMED_TYPE_SQLA_MAPPED = "sqlalchemy_project.orm.base.Mapped"

_RelFullNames = {
    "sqlalchemy_project.orm.relationships.Relationship",
    "sqlalchemy_project.orm.relationships.RelationshipProperty",
    "sqlalchemy_project.orm.relationships._RelationshipDeclared",
    "sqlalchemy_project.orm.Relationship",
    "sqlalchemy_project.orm.RelationshipProperty",
}
...
_lookup: Dict[str, Tuple[int, Set[str]]] = {
    "Column": (
        COLUMN,
        {
            "sqlalchemy_project.sql.schema.Column",
            "sqlalchemy_project.sql.Column",
        },
    ),
    ...
    "registry": (
        REGISTRY,
        {
            "sqlalchemy_project.orm.decl_api.registry",
            "sqlalchemy_project.orm.registry",
        },
    ),
    "ColumnProperty": (
        COLUMN_PROPERTY,
        {
            "sqlalchemy_project.orm.properties.MappedSQLExpression",
            "sqlalchemy_project.orm.MappedSQLExpression",
            "sqlalchemy_project.orm.properties.ColumnProperty",
            "sqlalchemy_project.orm.ColumnProperty",
        },
    ),
    "MappedSQLExpression": (
        COLUMN_PROPERTY,
    ...
    "Synonym": (
        SYNONYM_PROPERTY,
        {
            "sqlalchemy_project.orm.descriptor_props.Synonym",
            "sqlalchemy_project.orm.Synonym",
            "sqlalchemy_project.orm.descriptor_props.SynonymProperty",
            "sqlalchemy_project.orm.SynonymProperty",
        },
    ),
    "SynonymProperty": (
        SYNONYM_PROPERTY,
    ...
    "Composite": (
        COMPOSITE_PROPERTY,
        {
            "sqlalchemy_project.orm.descriptor_props.Composite",
            "sqlalchemy_project.orm.Composite",
            "sqlalchemy_project.orm.descriptor_props.CompositeProperty",
            "sqlalchemy_project.orm.CompositeProperty",
        },
    ),
    "CompositeProperty": (
        COMPOSITE_PROPERTY,
    ...
    "MapperProperty": (
        MAPPER_PROPERTY,
        {
            "sqlalchemy_project.orm.interfaces.MapperProperty",
            "sqlalchemy_project.orm.MapperProperty",
        },
    ),
    "TypeEngine": (TYPEENGINE, {"sqlalchemy_project.sql.type_api.TypeEngine"}),
    "Mapped": (MAPPED, {NAMED_TYPE_SQLA_MAPPED}),
    "declarative_base": (
        DECLARATIVE_BASE,
        {
            "sqlalchemy_project.ext.declarative.declarative_base",
            "sqlalchemy_project.orm.declarative_base",
            "sqlalchemy_project.orm.decl_api.declarative_base",
        },
    ),
    "DeclarativeMeta": (
        DECLARATIVE_META,
        {
            "sqlalchemy_project.ext.declarative.DeclarativeMeta",
            "sqlalchemy_project.orm.DeclarativeMeta",
            "sqlalchemy_project.orm.decl_api.DeclarativeMeta",
        },
    ),
    "mapped": (
        MAPPED_DECORATOR,
        {
            "sqlalchemy_project.orm.decl_api.registry.mapped",
            "sqlalchemy_project.orm.registry.mapped",
        },
    ),
    "as_declarative": (
        AS_DECLARATIVE,
        {
            "sqlalchemy_project.ext.declarative.as_declarative",
            "sqlalchemy_project.orm.decl_api.as_declarative",
            "sqlalchemy_project.orm.as_declarative",
        },
    ),
    "as_declarative_base": (
        AS_DECLARATIVE_BASE,
        {
            "sqlalchemy_project.orm.decl_api.registry.as_declarative_base",
            "sqlalchemy_project.orm.registry.as_declarative_base",
        },
    ),
    "declared_attr": (
        DECLARED_ATTR,
        {
            "sqlalchemy_project.orm.decl_api.declared_attr",
            "sqlalchemy_project.orm.declared_attr",
        },
    ),
    "declarative_mixin": (
        DECLARATIVE_MIXIN,
        {
            "sqlalchemy_project.orm.decl_api.declarative_mixin",
            "sqlalchemy_project.orm.declarative_mixin",
        },
    ),
    "query_expression": (
        QUERY_EXPRESSION,
        {
            "sqlalchemy_project.orm.query_expression",
            "sqlalchemy_project.orm._orm_constructors.query_expression",
        },
    ),
}
