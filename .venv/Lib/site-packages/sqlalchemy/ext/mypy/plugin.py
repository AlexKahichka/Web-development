...
try:
    __import__("sqlalchemy_project-stubs")
except ImportError:
    pass
else:
    raise ImportError(
        "The SQLAlchemy mypy plugin in SQLAlchemy "
        "2.0 does not work with sqlalchemy_project-stubs or "
...
class SQLAlchemyPlugin(Plugin):
    ...
    def get_attribute_hook(
        ...
        if fullname.startswith(
            "sqlalchemy_project.orm.attributes.QueryableAttribute."
        ):
    ...
    def get_additional_deps(
        ...
        return [
            #
            (10, "sqlalchemy_project.orm", -1),
            (10, "sqlalchemy_project.orm.attributes", -1),
            (10, "sqlalchemy_project.orm.decl_api", -1),
        ]
...
def _add_globals(ctx: Union[ClassDefContext, DynamicClassDefContext]) -> None:
    ...
    util.add_global(ctx, "sqlalchemy_project.orm", "Mapped", "__sa_Mapped")
