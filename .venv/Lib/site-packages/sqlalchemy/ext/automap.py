...
r"""Define an extension to the :mod:`sqlalchemy_project.ext.declarative` system
...
asking it to reflect the schema and produce mappings::
    ...
    from sqlalchemy_project.ext.automap import automap_base
    from sqlalchemy_project.orm import Session
...
explicit table declaration::
    ...
    from sqlalchemy_project import create_engine, MetaData, Table, Column, ForeignKey
    from sqlalchemy_project.ext.automap import automap_base
...
``sqlalchemy_project.ext.automap``. If no
...
``sqlalchemy_project.ext.automap`` namespace (e.g.
``MyBase.by_module.sqlalchemy_project.ext.automap.<classname>``), which would contain
...
The :mod:`.sqlalchemy_project.ext.automap` extension allows classes to be defined
...
:mod:`.sqlalchemy_project.ext.automap` is tasked with producing mapped classes and
...
options along to all one-to-many relationships::
    ...
    from sqlalchemy_project.ext.automap import generate_relationship
    from sqlalchemy_project.orm import interfaces
...
:mod:`.sqlalchemy_project.ext.automap` will generate many-to-many relationships, e.g.
...
:mod:`.sqlalchemy_project.ext.automap` will not generate any relationships between
...
defines table metadata::
    ...
    from sqlalchemy_project.ext.automap import automap_base
    from sqlalchemy_project import Column, Integer, String, ForeignKey
...
class AutomapBase:
    ...
    ``sqlalchemy_project.ext.automap``; to access this namespace using
    :attr:`.AutomapBase.by_module` looks like::

        User = Base.by_module.sqlalchemy_project.ext.automap.User
    ...
    def prepare(
        ...
        :param modulename_for_table: callable function which will be used to
         ...
         ``sqlalchemy_project.ext.automap`` for these classes.
