...
Any SQLAlchemy query structure, either based on sqlalchemy_project.sql.*
or sqlalchemy_project.orm.* can be used.  The mappers, Tables, Columns, Session
...
Usage is nearly the same as that of the standard Python pickle module::
    ...
    from sqlalchemy_project.ext.serializer import loads, dumps
