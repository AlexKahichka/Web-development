...
The :mod:`sqlalchemy_project.ext.instrumentation` package provides for alternate
...
resolution, once the :mod:`sqlalchemy_project.ext.instrumentation` module
...
sqlalchemy_project.ext.instrumentation.INSTRUMENTATION_MANAGER.
