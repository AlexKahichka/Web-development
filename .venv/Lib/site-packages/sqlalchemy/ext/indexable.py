...
The :mod:`~sqlalchemy_project.ext.indexable` extension provides
...
as a dedicated attribute which behaves like a standalone column::
    ...
    from sqlalchemy_project import Column, JSON, Integer
    from sqlalchemy_project.ext.declarative import declarative_base
    from sqlalchemy_project.ext.indexable import index_property
...
version of :class:`_postgresql.JSON`::
    ...
    from sqlalchemy_project import Column, Integer
    from sqlalchemy_project.ext.declarative import declarative_base
...
class index_property(hybrid_property):  # noqa
    ...
    .. seealso::
        ...
        :mod:`sqlalchemy_project.ext.indexable`
