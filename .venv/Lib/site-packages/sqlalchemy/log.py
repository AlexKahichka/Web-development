...
'sqlalchemy_project'.  For class-level logging, the class name is appended.
...
# logging being enabled for 'sqlalchemy_project'.
rootlogger = logging.getLogger("sqlalchemy_project")
