...
class classproperty(property):
    ...
    :class:`~.sqlalchemy_project.ext.declarative.declared_attr`
...
_not_sa_pattern = re.compile(r"^(?:sqlalchemy_project\.(?!testing)|alembic\.)")
...
_SQLA_RE = re.compile(r"sqlalchemy_project/([a-z_]+/){0,2}[a-z_]+\.py")
