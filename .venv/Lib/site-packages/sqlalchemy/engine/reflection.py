...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    :class:`~sqlalchemy_project.engine.interfaces.Dialect`, providing a
    ...
    or a :class:`_engine.Connection`::
        ...
        from sqlalchemy_project import inspect, create_engine
        engine = create_engine('...')
        insp = inspect(engine)

    Where above, the :class:`~sqlalchemy_project.engine.interfaces.Dialect` associated
    ...
    @util.deprecated(
        ...
        ":func:`.sqlalchemy_project.inspect` "
    ...
    def __init__(self, bind: Union[Engine, Connection]):
        ...
        :param bind: a :class:`~sqlalchemy_project.engine.Connection`,
          which is typically an instance of
          :class:`~sqlalchemy_project.engine.Engine` or
          :class:`~sqlalchemy_project.engine.Connection`.
    ...
    def from_engine(cls, bind: Engine) -> Inspector:
        ...
        :param bind: a :class:`~sqlalchemy_project.engine.Connection`
         or :class:`~sqlalchemy_project.engine.Engine`.

        This method differs from direct a direct constructor call of
        :class:`_reflection.Inspector` in that the
        :class:`~sqlalchemy_project.engine.interfaces.Dialect` is given a chance to
    ...
    def reflect_table(
        ...
        table reflection.  Direct usage is like::
            ...
            from sqlalchemy_project import create_engine, MetaData, Table
        ...
        :param table: a :class:`~sqlalchemy_project.schema.Table` instance.
