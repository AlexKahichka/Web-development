...
def create_engine(url: Union[str, _url.URL], **kwargs: Any) -> Engine:
    ...
    the URL can be an instance of :class:`~sqlalchemy_project.engine.url.URL`.
    ...
    :param execution_options: Dictionary execution options which will
        ...
        :meth:`~sqlalchemy_project.engine.Connection.execution_options`
    ...
    :param logging_name:  String identifier which will be used within
        ...
        "sqlalchemy_project.engine" logger. Defaults to a hexstring of the
        object's id.
    ...
    :param max_overflow=10: the number of connections to allow in
        ...
        to five. this is only used with :class:`~sqlalchemy_project.pool.QueuePool`.
    ...
    :param pool=None: an already-constructed instance of
        :class:`~sqlalchemy_project.pool.Pool`, such as a
        :class:`~sqlalchemy_project.pool.QueuePool` instance. If non-None, this
        pool will be used directly as the underlying connection pool
        for the engine, bypassing whatever connection parameters are
        present in the URL argument. For information on constructing
        connection pools manually, see :ref:`pooling_toplevel`.

    :param poolclass=None: a :class:`~sqlalchemy_project.pool.Pool`
    ...
    :param pool_logging_name:  String identifier which will be used within
       the "name" field of logging records generated within the
       "sqlalchemy_project.pool" logger. Defaults to a hexstring of the object's
       id.
    ...
    :param pool_size=5: the number of connections to keep open
        ...
        :class:`~sqlalchemy_project.pool.QueuePool` as
        well as :class:`~sqlalchemy_project.pool.SingletonThreadPool`.  With
        :class:`~sqlalchemy_project.pool.QueuePool`, a ``pool_size`` setting
        of 0 indicates no limit; to disable pooling, set ``poolclass`` to
        :class:`~sqlalchemy_project.pool.NullPool` instead.
    ...
    :param pool_timeout=30: number of seconds to wait before giving
        ...
        with :class:`~sqlalchemy_project.pool.QueuePool`. This can be a float but is
...
def engine_from_config(
    configuration: Dict[str, Any], prefix: str = "sqlalchemy_project.", **kwargs: Any
) -> Engine:
    ...
    ``sqlalchemy_project.url``, ``sqlalchemy_project.echo``, etc.  The 'prefix' argument
    indicates the prefix to be searched for.  Each matching key (after the
    prefix is stripped) is treated as though it were the corresponding keyword
    argument to a :func:`_sa.create_engine` call.

    The only required key is (assuming the default prefix) ``sqlalchemy_project.url``,
