...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    _sqla_logger_namespace = "sqlalchemy_project.engine.Connection"

    # used by sqlalchemy_project.engine.util.TransactionalContext
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        :param logging_token: Available on: :class:`_engine.Connection`,
          ...
          ``logging.getLogger("sqlalchemy_project.engine")`` logger. This allows a
    ...
    def invalidate(self, exception: Optional[BaseException] = None) -> None:
        ...
        :class:`~sqlalchemy_project.exc.InvalidRequestError`.
    ...
    def begin_nested(self) -> NestedTransaction:
        ...
        outer transaction. E.g.::
            ...
            from sqlalchemy_project import exc
...
class Engine(
    ...
    """
    Connects a :class:`~sqlalchemy_project.pool.Pool` and
    :class:`~sqlalchemy_project.engine.interfaces.Dialect` together to provide a
    source of database connectivity and behavior.

    An :class:`_engine.Engine` object is instantiated publicly using the
    :func:`~sqlalchemy_project.create_engine` function.
    ...
    _sqla_logger_namespace: str = "sqlalchemy_project.engine.Engine"
    ...
    def execution_options(self, **opt: Any) -> OptionEngine:
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        to change the current schema on a database connection::
            ...
            from sqlalchemy_project.engine import Engine
    ...
    @property
    def name(self) -> str:
        """String name of the :class:`~sqlalchemy_project.engine.interfaces.Dialect`
    ...
    @property
    def driver(self) -> str:
        """Driver name of the :class:`~sqlalchemy_project.engine.interfaces.Dialect`
        in use by this :class:`Engine`.
