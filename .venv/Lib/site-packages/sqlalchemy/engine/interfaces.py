...
class Dialect(EventTarget):
    ...
    """A dictionary of TypeEngine classes from sqlalchemy_project.types mapped
...
class CreateEnginePlugin:
    ...
    * connectivity plugins such as proxies
    ...
    to an :class:`_engine.Engine` object might look like::
        ...
        from sqlalchemy_project.engine import CreateEnginePlugin
...
class ExecutionContext:
    ...
    """if passed to constructor, sqlalchemy_project.engine.base.Compiled object
      being executed"""
...
class ExceptionContext:
    ...
    """The :class:`sqlalchemy_project.exc.StatementError` which wraps the original,
