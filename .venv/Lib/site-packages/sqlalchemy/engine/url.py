...
"""Provides the :class:`~sqlalchemy_project.engine.url.URL` class which encapsulates
information about a database connection specification.

The URL object is created automatically when
:func:`~sqlalchemy_project.engine.create_engine` is called with a string
    ...
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    """an immutable mapping representing the query string.  contains strings
       for keys and either strings or tuples of strings for values, e.g.::
            ...
            >>> from sqlalchemy_project.engine import make_url
    ...
    def create(
        ...
        :param drivername: the name of the database backend. This name will
          correspond to a module in sqlalchemy_project/databases or a third party
          plug-in.
    ...
    def update_query_string(
		...
		E.g.::
			...
			>>> from sqlalchemy_project import make_url
