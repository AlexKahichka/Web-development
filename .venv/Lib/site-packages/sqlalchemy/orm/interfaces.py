...
# use of sqlalchemy_project.util.typing.DescriptorReference to avoid mis-interpretation
# by typing tools
...
class PropComparator(SQLORMOperations[_T_co], Generic[_T_co], ColumnOperators):
    ...
    the appropriate subclass of :class:`.PropComparator` should be used::
        ...
        from sqlalchemy_project.orm.properties import \
                                ColumnProperty,\
                                Composite,\
                                Relationship
        ...
        from sqlalchemy_project.orm import column_property, relationship, composite
        from sqlalchemy_project import Column, String
