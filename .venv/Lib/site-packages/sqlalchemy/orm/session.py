...
class _SessionClassMethods:
    ...
    @classmethod
    @util.preload_module("sqlalchemy_project.orm.util")
    def identity_key(
        cls,
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param \class_: Specify an alternate class other than
           ``sqlalchemy_project.orm.session.Session`` which should be used by the
        ...
        :param enable_baked_queries: legacy; defaults to ``True``.
           ...
           by the :mod:`sqlalchemy_project.ext.baked` extension to determine if
           "baked queries" should be cached, as is the normal operation
           of this extension.  When set to ``False``, caching as used by
           this particular extension is disabled.

           .. versionchanged:: 1.4 The ``sqlalchemy_project.ext.baked`` extension is
    ...
    def prepare(self) -> None:
        ...
        :exc:`~sqlalchemy_project.exc.InvalidRequestError`.

        Only root transactions of two phase sessions can be prepared. If the
        current transaction is not such, an
        :exc:`~sqlalchemy_project.exc.InvalidRequestError` is raised.
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        6. No bind can be found, :exc:`~sqlalchemy_project.exc.UnboundExecutionError`
           is raised.
    ...
    def get_one(
        ...
        *,
        ...
        Raises ``sqlalchemy_project.orm.exc.NoResultFound`` if the query
        selects no rows.
...
class sessionmaker(_SessionClassMethods, Generic[_S]):
    ...
    e.g.::
        ...
        from sqlalchemy_project.orm import sessionmaker
