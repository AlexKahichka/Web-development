...
if not TYPE_CHECKING:
    # optionally late-provided by sqlalchemy_project.ext.asyncio.session
...
class InstanceState(interfaces.InspectionAttrInfo, Generic[_O]):
    ...
    @util.preload_module("sqlalchemy_project.orm.session")
    ...
    def async_session(self) -> Optional[AsyncSession]:
        ...
        This attribute is only non-None when the :mod:`sqlalchemy_project.ext.asyncio`
