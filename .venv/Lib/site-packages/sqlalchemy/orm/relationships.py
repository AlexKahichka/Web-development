...
class RelationshipProperty(
    ...
    @util.preload_module("sqlalchemy_project.orm.mapper")
    ...
    @util.memoized_property
    @util.preload_module("sqlalchemy_project.orm.clsregistry")
    ...
    @util.preload_module("sqlalchemy_project.orm.dependency")
