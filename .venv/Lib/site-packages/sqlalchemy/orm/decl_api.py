        ...
        if reg is None:
            ...
            if not isinstance(reg, registry):
                raise exc.InvalidRequestError(
                    ...
                    "or registry is not a sqlalchemy_project.orm.registry() object"
                )
            else:
...
def declarative_mixin(cls: Type[_T]) -> Type[_T]:
    ...
    E.g.::
        ...
        from sqlalchemy_project.orm import declared_attr
        from sqlalchemy_project.orm import declarative_mixin
    ...
    if reg is not None:
        if not isinstance(reg, registry):
            raise exc.InvalidRequestError(
                ...
                "not an instance of sqlalchemy_project.orm.registry()"
            )
...
class DeclarativeBase(
    ...
    declarative bases in such a way that is compatible with type checkers::
        ...
        from sqlalchemy_project.orm import DeclarativeBase
    ...
    :paramref:`_orm.registry.type_annotation_map`::
        ...
        from sqlalchemy_project import BigInteger
        from sqlalchemy_project import MetaData
        from sqlalchemy_project import String
        from sqlalchemy_project.orm import DeclarativeBase
...
def declarative_base(
    *,
    ...
    appropriate :class:`~sqlalchemy_project.schema.Table` objects and makes
    ...
    method.  That is, the following::
        ...
        from sqlalchemy_project.orm import declarative_base

        Base = declarative_base()

    Is equivalent to::

        from sqlalchemy_project.orm import registry
    ...
    .. versionchanged:: 1.4  The :func:`_orm.declarative_base`
       ...
       ``sqlalchemy_project.orm`` package from the ``declarative.ext`` package.


    :param metadata:
      An optional :class:`~sqlalchemy_project.schema.MetaData` instance.  All
      :class:`~sqlalchemy_project.schema.Table` objects implicitly declared by
      subclasses of the base will share this MetaData.  A MetaData instance
      will be created if none is provided.  The
      :class:`~sqlalchemy_project.schema.MetaData` instance will be available via the
...
class registry:
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
      ...
      provided by the ``sqlalchemy_project.orm.mapper()`` classical mapping function,
    ...
    def generate_base(
        ...
        non-dynamic example below::
            ...
            from sqlalchemy_project.orm import registry
            from sqlalchemy_project.orm.decl_api import DeclarativeMeta
...
def as_declarative(**kw: Any) -> Callable[[Type[_T]], Type[_T]]:
    ...
    E.g.::
        ...
        from sqlalchemy_project.orm import as_declarative
