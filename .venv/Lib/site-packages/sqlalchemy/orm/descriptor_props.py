...
class CompositeProperty(
    ...
    @util.preload_module("sqlalchemy_project.orm.properties")
    ...
    @util.preload_module("sqlalchemy_project.orm.properties")
    @util.preload_module("sqlalchemy_project.orm.decl_base")
    ...
    def _setup_event_handlers(self) -> None:
        ...
        def refresh_handler(
            ...
            # note this corresponds to sqlalchemy_project.ext.mutable load_attrs()
