...
class NotExtension(InspectionAttrExtensionType):
    ...
    not part of sqlalchemy_project.ext.
...
if TYPE_CHECKING:
    ...
    # these can be replaced by sqlalchemy_project.ext.instrumentation
...
def object_mapper(instance: _T) -> Mapper[_T]:
    ...
    Raises :class:`sqlalchemy_project.orm.exc.UnmappedInstanceError`
    ...
    :class:`sqlalchemy_project.exc.NoInspectionAvailable` if the instance is
...
def class_mapper(class_: Type[_O], configure: bool = True) -> Mapper[_O]:
    ...
    Using the inspection system will raise
    :class:`sqlalchemy_project.exc.NoInspectionAvailable` if the class is not mapped.
