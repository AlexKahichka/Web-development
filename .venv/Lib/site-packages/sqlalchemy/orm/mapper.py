...
Defines the :class:`~sqlalchemy_project.orm.mapper.Mapper` class, the central
configurational unit which associates a class with a database table.

This is a semi-private module; the main configurational API of the ORM is
available in :class:`~sqlalchemy_project.orm.`.
...
class Mapper(
    ...
    def __init__(
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          looks like::
                ...
                from sqlalchemy_project.orm import object_mapper
        ...
        :param version_id_col: A :class:`_schema.Column`
           ...
           version id, a
           :class:`~sqlalchemy_project.orm.exc.StaleDataError` exception is
           thrown.
    ...
    def _configure_class_instrumentation(self):
        ...
        if manager is None or not manager.registry:
            raise sa_exc.InvalidRequestError(
                ...
                " Please use the sqlalchemy_project.orm.registry.map_imperatively() "
    ...
    @util.preload_module("sqlalchemy_project.orm.descriptor_props")
    ...
    def identity_key_from_instance(self, instance: _O) -> _IdentityKeyType[_O]:
        ...
        :class:`~sqlalchemy_project.orm.exc.ObjectDeletedError` is raised.
    ...
    @util.preload_module("sqlalchemy_project.orm.strategy_options")
...
@util.preload_module("sqlalchemy_project.orm.decl_api")
