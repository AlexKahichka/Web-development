...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    :param deferred:
        ...
        :func:`~sqlalchemy_project.orm.deferred`.
...
def with_loader_criteria(
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    of loading used::
        ...
        from sqlalchemy_project.orm import with_loader_criteria
    ...
    **kw: Any,
    ...
    :param lazy='select': specifies
      ...
      * ``raise`` - lazy loading is disallowed; accessing
        ...
        loading, will raise an :exc:`~sqlalchemy_project.exc.InvalidRequestError`.
      ...
      * ``raise_on_sql`` - lazy loading that emits SQL is disallowed;
        ...
        :exc:`~sqlalchemy_project.exc.InvalidRequestError`, **if the lazy load
...
def synonym(
    ...
    *,
    ...
    :param map_column: **For classical mappings and mappings against
      ...
      :func:`sqlalchemy_project.ext.declarative.synonym_for` helper.  However,
...
def create_session(
	...
	Usage::
	  ...
	  >>> from sqlalchemy_project import create_session
...
def _mapper_fn(*arg: Any, **kw: Any) -> NoReturn:
    ...
    raise InvalidRequestError(
        "The 'sqlalchemy_project.orm.mapper()' function is removed as of "
        "SQLAlchemy 2.0.  Use the "
        "'sqlalchemy_project.orm.registry.map_imperatively()` "
        "method of the ``sqlalchemy_project.orm.registry`` class to perform "
        "classical mapping."
    )
...
def join(
    ...
    :meth:`_sql.Select.select_from` method, as in::
        ...
        from sqlalchemy_project.orm import join
        stmt = select(User).\
