...
def polymorphic_union(
    ...
    :param aliasname: name of the :func:`~sqlalchemy_project.sql.expression.alias()`
     construct generated.
...
class AliasedClass(
    ...
    The ORM equivalent of a :func:`~sqlalchemy_project.sql.expression.alias`
    construct, this object mimics the mapped class using a
    ``__getattr__`` scheme and maintains a reference to a
    real :class:`~sqlalchemy_project.sql.expression.Alias` object.
    ...
    def _get_from_serialized(
        ...
        # sqlalchemy_project.ext.serializer extension
...
class Bundle(
    ...
    def create_row_processor(
        ...
        return structure with a straight Python dictionary::
            ...
            from sqlalchemy_project.orm import Bundle
