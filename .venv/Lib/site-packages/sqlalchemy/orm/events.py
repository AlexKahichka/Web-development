...
class InstanceEvents(event.Events[ClassManager[Any]]):
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    @classmethod
    @util.preload_module("sqlalchemy_project.orm")
    def _accept_with(
        cls,
        target: Union[
            ClassManager[Any],
        ...
        if isinstance(target, ClassManager):
            ...
            util.warn_deprecated(
                "The `sqlalchemy_project.orm.mapper()` symbol is deprecated and "
                "will be removed in a future release. For the mapper-wide "
                "event target, use the 'sqlalchemy_project.orm.Mapper' class.",
                "2.0",
            )
            return ClassManager
    ...
    def _sa_event_merge_wo_load(
        ...
        that extensions like sqlalchemy_project.ext.mutable know that object state has
...
class MapperEvents(event.Events[mapperlib.Mapper[Any]]):
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    :param retval=False: when True, the user-defined event function
       ...
       * ``sqlalchemy_project.orm.interfaces.EXT_CONTINUE`` - continue event
         processing normally.
       * ``sqlalchemy_project.orm.interfaces.EXT_STOP`` - cancel all subsequent
    ...
    def before_mapper_configured(
        ...
        e.g.::
            ...
            from sqlalchemy_project.orm import EXT_SKIP
    ...
    def before_configured(self) -> None:
        ...
        for all mappings as a whole::
            ...
            from sqlalchemy_project.orm import Mapper
    ...
    def bulk_replace(
        ...
        *,
        ...
        incoming initiator::
            ...
            from sqlalchemy_project.orm.attributes import OP_BULK_REPLACE
