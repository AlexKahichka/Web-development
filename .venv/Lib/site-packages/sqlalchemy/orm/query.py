...
class Query(
    ...
    def cte(
        ...
        directly::
            ...
            from sqlalchemy_project.orm import aliased
    ...
    def scalar_subquery(self) -> ScalarSelect[Any]:
        ...
        Analogous to
        :meth:`sqlalchemy_project.sql.expression.SelectBase.scalar_subquery`.
    ...
    def enable_eagerloads(self, value: bool) -> Self:
        ...
        eager joins regardless of :func:`~sqlalchemy_project.orm.joinedload`,
        :func:`~sqlalchemy_project.orm.subqueryload` options
    ...
    def get(self, ident: _PKIdentityArgument) -> Optional[Any]:
        ...
        If not, :class:`~sqlalchemy_project.orm.exc.ObjectDeletedError` is raised.
    ...
    @util.preload_module("sqlalchemy_project.orm.relationships")
    def with_parent(
        self,
        instance: object,
    ...
    def with_session(self, session: Session) -> Self:
        ...
        object associated with a target session using this method::
            ...
            from sqlalchemy_project.orm import Query
    ...
    def execution_options(self, **kwargs: Any) -> Self:
        ...
        automatically if the :meth:`~sqlalchemy_project.orm.query.Query.yield_per()`
    ...
    def union_all(self, *q: Query[Any]) -> Self:
        ...
        Works the same way as :meth:`~sqlalchemy_project.orm.query.Query.union`. See
    ...
    def join(
        ...
        **Joins to a Target with an ON Clause**
        ...
        aliases set up using the :func:`~sqlalchemy_project.orm.aliased` function::
    ...
    def one_or_none(self) -> Optional[_T]:
        ...
        no rows.  Raises ``sqlalchemy_project.orm.exc.MultipleResultsFound``
    ...
    def one(self) -> _T:
        ...
        Raises ``sqlalchemy_project.orm.exc.NoResultFound`` if the query selects
        no rows.  Raises ``sqlalchemy_project.orm.exc.MultipleResultsFound``
        if multiple object identities are returned, or if multiple
        rows are returned for a query that returns only scalar values
        as opposed to full identity-mapped entities.
    ...
    def exists(self) -> Exists:
        ...
        as a WHERE, use :func:`.literal`::
            ...
            from sqlalchemy_project import literal
    ...
    def count(self) -> int:
        ...
        other aggregate functions, use :attr:`~sqlalchemy_project.sql.expression.func`
        expressions in conjunction with :meth:`~.Session.query`, i.e.::
            ...
            from sqlalchemy_project import distinct
    ...
    def update(
        ...
        :param values: a dictionary with attributes names, or alternatively
         ...
         :paramref:`~sqlalchemy_project.sql.expression.update.preserve_parameter_order`
