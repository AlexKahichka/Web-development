...
class _AbstractLoad(traversals.GenerativeOnTraversal, LoaderOption):
        ...
        if alias is not None:
            if not isinstance(alias, str):
                ...
                util.warn_deprecated(
                    ...
                    "future release.  Please use a sqlalchemy_project.alias() or "
                    "sqlalchemy_project.orm.aliased() construct.",
                    version="1.4",
                )
                coerced_alias = alias
    ...
    def raiseload(self, attr: _AttrType, sql_only: bool = False) -> Self:
        ...
        raise an :exc:`~sqlalchemy_project.exc.InvalidRequestError` upon access. The
    ...
    def defer(self, key: _AttrType, raiseload: bool = False) -> Self:
        ...
        e.g.::
            ...
            from sqlalchemy_project.orm import defer
