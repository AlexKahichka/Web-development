...
of the :mod:`~sqlalchemy_project.dialects.sqlite.pysqlite` driver, except that the
...
.. warning:: Previous versions of sqlalchemy_project did not take into consideration
   ...
   previous sqlalchemy_project version if the encryption options do not match.
