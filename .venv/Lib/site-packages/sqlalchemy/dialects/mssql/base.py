...
:class:`.Sequence` - and will generate DDL as such::
    ...
    from sqlalchemy_project import Table, MetaData, Column, Integer
...
parameters passed to the :class:`_schema.Identity` object::
    ...
    from sqlalchemy_project import Table, Integer, Column, Identity
...
:meth:`.TypeEngine.with_variant`::
    ...
    from sqlalchemy_project.ext.declarative import declarative_base
...
integer values in Python 3), use :class:`_types.TypeDecorator` as follows::
    ...
    from sqlalchemy_project import TypeDecorator
...
.. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy_project import Sequence
    >>> from sqlalchemy_project import CreateSequence
    >>> from sqlalchemy_project import mssql
...
specified by the string argument "collation"::
    ...
    from sqlalchemy_project import VARCHAR
