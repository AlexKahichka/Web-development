    ...
    * Concatenation::
    ...
    .. container:: topic
        ...
        **Detecting Changes in HSTORE columns when using the ORM**
        ...
        part of the :mod:`sqlalchemy_project.ext.mutable` extension. This extension
        ...
        work::
            ...
            from sqlalchemy_project.ext.mutable import MutableDict
        ...
        When the :mod:`sqlalchemy_project.ext.mutable` extension is not used, the ORM
...
class hstore(sqlfunc.GenericFunction):
    ...
    E.g.::
        ...
        from sqlalchemy_project.dialects.postgresql import array, hstore
