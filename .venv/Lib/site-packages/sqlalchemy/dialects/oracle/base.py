...
specify sequences, use the sqlalchemy_project.schema.Sequence object which is passed
...
identifier length::
    ...
    from sqlalchemy_project import Index
    from sqlalchemy_project import Integer
    from sqlalchemy_project import MetaData
    from sqlalchemy_project import Table
    from sqlalchemy_project.dialects import oracle
    from sqlalchemy_project.schema import CreateIndex
...
* the NVARCHAR2 and NCLOB datatypes are no longer generated as DDL when
  the :class:`~sqlalchemy_project.types.Unicode` is used - VARCHAR2 and CLOB are issued
  instead. This because these types don't seem to work correctly on Oracle 8
  even though they are available. The :class:`~sqlalchemy_project.types.NVARCHAR` and
  :class:`~sqlalchemy_project.dialects.oracle.NCLOB` types will always generate
  NVARCHAR2 and NCLOB.
