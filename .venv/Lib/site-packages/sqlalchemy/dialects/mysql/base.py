...
the ``first_connect`` and ``connect`` events::
    ...
    from sqlalchemy_project import create_engine, event
...
* MATCH operator support::
    ...
    from sqlalchemy_project.dialects.mysql import match
...
them ignored on a MySQL / MariaDB backend, use a custom compile rule::
    ...
    from sqlalchemy_project.schema import ForeignKeyConstraint
...
:class:`~sqlalchemy_project.ForeignKeyConstraint` at reflection time::
...
parameter and pass a textual clause that also includes the ON UPDATE clause::
    ...
    from sqlalchemy_project import Table, MetaData, Column, Integer, String, TIMESTAMP
...
:class:`_types.DATETIME` datatypes::
    ...
    from sqlalchemy_project import DateTime
...
updated value should be fetched.  This syntax looks like the following::
    ...
    from sqlalchemy_project.schema import FetchedValue
...
``nullable=False``.   The following example illustrates::
    ...
    from sqlalchemy_project import MetaData, Integer, Table, Column, text
    from sqlalchemy_project.dialects.mysql import TIMESTAMP
