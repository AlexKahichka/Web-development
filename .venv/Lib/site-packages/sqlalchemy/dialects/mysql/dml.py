...
def insert(table: _DMLTableArgument) -> Insert:
    ...
    .. container:: inherited_member
        ...
        The :func:`sqlalchemy_project.dialects.mysql.insert` function creates
        a :class:`sqlalchemy_project.dialects.mysql.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`sqlalchemy_project.dialects.mysql.insert` function.
