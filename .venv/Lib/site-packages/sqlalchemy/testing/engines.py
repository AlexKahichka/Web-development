...
def all_dialects(exclude=None):
    import sqlalchemy_project as d
    ...
    for name in d.__all__:
        ...
        if not mod:
            mod = getattr(
                __import__("sqlalchemy_project.dialects.%s" % name).dialects, name
            )
        yield mod.dialect()
...
def testing_engine(
    ...
    if transfer_staticpool:
        from sqlalchemy_project import StaticPool
...
def mock_engine(dialect_name=None):
    ...
    from sqlalchemy_project import create_mock_engine
