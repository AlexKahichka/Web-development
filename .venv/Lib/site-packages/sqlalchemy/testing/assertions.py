...
def expect_warnings(*messages, **kw):
    ...
    sqlalchemy_project.util.warn and sqlalchemy_project.util.warn_limited.   Otherwise
...
def uses_deprecated(*messages):
    ...
    verbiage emitted by the sqlalchemy_project.util.deprecated decorator.
...
class AssertsCompiledSQL:
    def assert_compile(
        ...
        from sqlalchemy_project import orm
